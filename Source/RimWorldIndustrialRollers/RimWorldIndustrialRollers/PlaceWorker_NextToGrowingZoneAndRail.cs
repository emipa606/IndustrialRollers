...
internal class PlaceWorker_NextToGrowingZoneAndRail : PlaceWorker
{
        ...
        Thing thingToIgnore = null, Thing thing = null)
    {
        ...
        foreach (var item in frontAndBack)
        {
            ...
            {
                if (northEast && map.zoneManager.ZoneAt(item) != null && map.zoneManager.ZoneAt(item) is Zone_Growing)
                {
                    num++;
                }
        ...
        return num >= 2 ? true : "MovingRail_MustPlaceNextToGrowzoneAndRail".Translate();
    }
